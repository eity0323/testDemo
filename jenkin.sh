...
result='curl -X POST \ -d "registry=${REGISTRY_HOST}&userName=$USER_NAME&image=$IMAGE&tag=${buildtime}&startPort=8080&desout=180000&start_timeout=120000&stop_timeout=120000&destory_timeout=120000" \ http://172.16.49.81:5081/svn/ws/registry/registResourceFromCI'
echo $result
